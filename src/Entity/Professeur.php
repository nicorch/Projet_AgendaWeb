...
class Professeur
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Avis", mappedBy="professeur", orphanRemoval=true)
     */
    private $avis;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Cours", mappedBy="professeur", orphanRemoval=true)
     */
    private $cours;
